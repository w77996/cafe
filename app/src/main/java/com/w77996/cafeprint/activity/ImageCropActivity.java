package com.w77996.cafeprint.activity;
...
import com.w77996.cafeprint.MainActivity;
...
//            mCropImageView.saveBitmapToFile(ImageCropActivity.this,imagePicker.getCropCacheFolder(this), mOutputX, mOutputY, mIsSaveRectangle);
            mCropImageView.getBitmap(ImageCropActivity.this);
...
//        Toast.makeText(ImageCropActivity.this, "裁剪成功:" + file.getAbsolutePath(), Toast.LENGTH_SHORT).show();
       ...
       /* ImageItem imageItem = new ImageItem();
        ...
        setResult(Constants.IMAGE_CROP_CODE,intent);
        finish();
    }
